CREATE DATABASE  IF NOT EXISTS `santacruz` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `santacruz`;
...
INSERT INTO `products` (`product_id`, `product_name`, `product_type`, `product_price`, `product_stock`, `product_code`, `product_brand`, `product_photo`) VALUES (1,'Table santa cruz','table',8002,1001,'asdasdqw1','santacruz','Table_santa_cruz_6.jpg');
...
-- Dump completed on 2023-11-21 22:31:34
